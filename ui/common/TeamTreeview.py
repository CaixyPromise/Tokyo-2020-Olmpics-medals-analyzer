...
class TeamTreeview(TreeViewUtils):
    ...
    def __init__(self, parent):
        self.__custom_headings = {
            "#0": {"text": "国家名称", "anchor": 'center'},
            "#1": {"text": "国家代码", "anchor": 'center'},
        ...
        self.__custom_columns = {
            "#0": {"minwidth": 10, "width": 100, "stretch": 1, "anchor": 'center'},
            "#1": {"minwidth": 20, "width": 100, "stretch": 1, "anchor": 'center'},
        ...
        super(TeamTreeview, self).__init__(parent = parent,
                                           columns = ('国家名称', '国家代码', '团队总人数', '管理员名称', '管理员联系方式', ),
